...
// TODO: Use tab storage instead of cookies
...
function Sidebar({
  ...
  // Desktop sidebar - uses resizable panel layout (no fixed positioning)
  return (
    <div
      ...
      <div className="absolute bottom-0 left-0">
        <Tooltip>
          ...
          <TooltipTrigger asChild>
            <SidebarTrigger variant="outline" className="mx-2 my-2" />
          </TooltipTrigger>
        </Tooltip>
      </div>
    );
